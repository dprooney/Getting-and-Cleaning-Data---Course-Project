...
if (!exists("tr_xt")) tr_xt<-read.table("train/X_train.txt")
if (!exists("tr_yt")) tr_yt<-read.table("train/y_train.txt")
if (!exists("tr_st")) tr_st<-read.table("train/subject_train.txt")
if (!exists("te_xt")) te_xt<-read.table("test/X_test.txt")
if (!exists("te_yt")) te_yt<-read.table("test/y_test.txt")
if (!exists("te_st")) te_st<-read.table("test/subject_test.txt")
